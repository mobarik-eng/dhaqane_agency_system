...
$pageInfo = [
    ...
    'subtitle' => 'Booking Financials'
];
$currentPage = 'travel_payments';

// Fetch Travel Payments
$stmt = $pdo->prepare("SELECT * FROM payments WHERE related_type = 'Travel' ORDER BY payment_date DESC");
$stmt->execute();
